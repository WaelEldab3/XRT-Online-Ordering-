...
const EditItemLayout = (props: any) => {
  const { role } = getAuthCredentials();
  const isAdmin = hasAccess(adminOnly, role);

  // Check if we are in a shop context (URL contains logic for shop)
  // or simply if the user is an admin accessing a global item
  if (isAdmin) {
...
EditItemPage.Layout = EditItemLayout;
