...
import { getPermissionDTOs, PERMISSION_DEFINITIONS, PermissionDefinition } from './permissionDefinitions';
...
class PermissionRegistry {
    ...
    async syncWithDatabase(): Promise<{ inserted: number; skipped: number; total: number }> {
        ...
        console.log(`   - New permissions: ${result.inserted}`);
        console.log(`   - Existing (skipped): ${result.skipped}`);
        console.log(`   - Total registered: ${permissionDTOs.length}\n`);
