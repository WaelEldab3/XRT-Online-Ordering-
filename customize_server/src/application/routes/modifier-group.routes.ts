...
router.get(
  ...
  modifierGroupController.getAll
);
...
router.get(
  '/:id',
  requirePermission('modifier_groups:read'),
  modifierGroupController.getById
);

// Create modifier group - requires modifier_groups:create permission
router.post(
  '/',
  requirePermission('modifier_groups:create'),
  modifierGroupController.create
);

// Update modifier group - requires modifier_groups:update permission
router.put(
  '/:id',
  requirePermission('modifier_groups:update'),
  modifierGroupController.update
);

// Delete modifier group - requires modifier_groups:delete permission
router.delete(
  '/:id',
  requirePermission('modifier_groups:delete'),
  modifierGroupController.delete
);
