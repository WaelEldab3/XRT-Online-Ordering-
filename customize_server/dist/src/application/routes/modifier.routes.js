...
router.post('/modifier-groups/:groupId/modifiers/sort-order', auth_1.requireAuth, modifierController.updateSortOrder);
// Export modifiers
router.get('/modifiers/export', (0, authorize_1.requirePermission)('modifiers:read'), modifierController.exportModifiers);
