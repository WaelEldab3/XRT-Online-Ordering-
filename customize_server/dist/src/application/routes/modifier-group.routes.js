...
router.post('/sort-order', auth_1.requireAuth, modifierGroupController.updateSortOrder);
// Modifiers sort order update within a group
router.post('/:id/modifiers/sort-order', (0, authorize_1.requirePermission)('modifiers:update'), modifierGroupController.updateModifiersSortOrder);
// Export modifier groups - requires modifier_groups:read permission
router.get('/export', (0, authorize_1.requirePermission)('modifier_groups:read'), modifierGroupController.exportModifierGroups);
