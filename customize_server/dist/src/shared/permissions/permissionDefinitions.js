...
exports.PERMISSION_DEFINITIONS = void 0;
exports.getPermissionDTOs = getPermissionDTOs;
 ...
 */
function getPermissionDTOs() {
    return exports.PERMISSION_DEFINITIONS.map((def) => ({
        key: def.key,
        module: def.module,
        action: def.action,
...
function getPermissionsByModule() {
    const grouped = {};
    for (const perm of exports.PERMISSION_DEFINITIONS) {
