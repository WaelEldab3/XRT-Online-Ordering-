...
class FinalSaveImportUseCase {
    constructor(importSessionRepository) {
        ...
        this.importSaveService = new ImportSaveService_1.ImportSaveService(itemRepository, itemSizeRepository, modifierGroupRepository, modifierRepository, categoryRepository);
    }
