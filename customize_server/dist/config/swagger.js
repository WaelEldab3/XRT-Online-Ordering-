...
- Error: \`{ "success": false, "message": "Error description" }\``,
    ...
    servers: [
        {
            url: process.env.PRODUCTION_URL || `https://xrt-online-ordering.vercel.app${env_js_1.env.API_BASE_URL}`,
            description: 'Production',
        },
        {
            url: `http://localhost:${env_js_1.env.PORT}${env_js_1.env.API_BASE_URL}`,
